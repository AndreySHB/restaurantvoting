...
import static ru.javawebinar.restaurantvoting.web.user.UserController.ADMIN_USERS;
...
class UserControllerTest extends AbstractControllerTest {
    ...
    void get() throws Exception {
        perform(MockMvcRequestBuilders.get(ADMIN_USERS + ADMIN_ID)
    ...
    void getNotFound() throws Exception {
        perform(MockMvcRequestBuilders.get(ADMIN_USERS + NOT_FOUND)
                .with(TestUtil.userHttpBasic(admin)))
                .andDo(print())
    ...
    void getByEmail() throws Exception {
        perform(MockMvcRequestBuilders.get(ADMIN_USERS + "by-email?email=" + admin.getEmail())
                .with(TestUtil.userHttpBasic(admin)))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(USER_MATCHER.contentJson(admin));
    ...
    void delete() throws Exception {
        perform(MockMvcRequestBuilders.delete(ADMIN_USERS + USER_ID)
                .with(TestUtil.userHttpBasic(admin)))
                .andDo(print())
    ...
    void deleteNotFound() throws Exception {
        perform(MockMvcRequestBuilders.delete(ADMIN_USERS + NOT_FOUND)
                .with(TestUtil.userHttpBasic(admin)))
                .andDo(print())
    ...
    void update() throws Exception {
        ...
        updated.setId(null);
        perform(MockMvcRequestBuilders.put(ADMIN_USERS + USER_ID)
                .with(TestUtil.userHttpBasic(admin))

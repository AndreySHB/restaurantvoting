package ru.javawebinar.restaurantvoting.config;
...
import ru.javawebinar.restaurantvoting.web.AuthUser;

import java.util.Optional;

import static ru.javawebinar.restaurantvoting.util.UserUtil.PASSWORD_ENCODER;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/api/votes/**").hasRole(Role.ADMIN.name())
